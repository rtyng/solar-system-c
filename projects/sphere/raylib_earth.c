...
Current Lighting Goal:
    Just work on making half the sphere darker

Milestones for realistic lighting

Phase 1:
Hard day/night split

Phase 2:
Smooth twilight zone

Phase 3:
Atmospheric glow

Phase 4:
City lights texture on night side

Phase 5:
Cloud layer

Pretty much all of the above are going to be about the best way to pass the LightingDirection vector through that dot product in fs
*/
#include <raylib.h>
#include <math.h>
#include <raymath.h>
...
{   
    ...
    // GenMeshSphere generates a Mesh struct that includes surface normals 
    // automatically point straight outward from the center
    ...
    {   
        ...
        */
        ...
        /*
        for now this space obove the start of drawing will be blank but 
        it will be for updating the shader values for when the lighting 
        will be updated with the earth's rotation, and eventually for other lighting effects.
        */
