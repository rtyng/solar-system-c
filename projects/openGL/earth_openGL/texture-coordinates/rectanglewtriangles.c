/*
Rectangle = 4 unique vertices
Draw as two triangles
Using 6 indices


Importance:
- Teaches Texture Coordinates for an Earth in OpenGL
*/
#include <GL/glew.h>
...
int main(void) {
    ...
    // Set up Element Buffer Object (EBO), VAO, and VBO
    ...
    // Bind the EBO and copy the index data to it | this needs to happend before unbinding the VAO
    glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, EBO);
    glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(indices), indices, GL_STATIC_DRAW);
