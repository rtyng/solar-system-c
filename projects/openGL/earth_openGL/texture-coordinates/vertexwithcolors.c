/*
This is a simple example of a vertex with position and color data.

Only need to add these three things to the working shader triangle example:

1. Vertex shader accepts position + color
2. Fragment shader uses the passed-in color
3. VAO/VBO uses stride + offset
