# Modeling and Simulating the Solar System in C and C++ -> Main project located in solar-system-cpp

This repository documents my journey learning computer graphics,
mathematics, simulation, and visualization using C, Raylib,
and eventually OpenGL.

Current goals:

- Learn graphics fundamentals
- Build mathematical visualizations
...
- The solar system simulation follows an OOP design philosphy
- Starting with 2 bodies, then incrementally building up to include the rest of the planets
